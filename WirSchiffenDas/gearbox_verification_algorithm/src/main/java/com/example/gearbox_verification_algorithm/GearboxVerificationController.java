...
@RestController
public class GearboxVerificationController {

	private static final String template = "Im the GearboxVerificator";
	...
	@PostMapping("/gearbox/optional_equipment")
	public String executeAlgorithm(
		...
		if (counter % 3 == 0) {
			...
			return "gearbox equipment validated.";
		}
	}
	...
	public void invoke_next_algorithm() {
		 ...
		 */
		final String url = "http://localhost:8083/monitoring/optional_equipment";
		RestTemplate restTemplate = new RestTemplate();
		// restTemplate.postForObject(url, "test", String.class);
