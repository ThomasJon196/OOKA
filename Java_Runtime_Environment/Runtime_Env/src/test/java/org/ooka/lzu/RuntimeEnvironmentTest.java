...
public class RuntimeEnvironmentTest {
    ...
    @Test
    public void deployComponent_ComponentWithStartAnnotation_IsDeployed() throws Exception {
        // given
    ...
    @Test
    public void deployComponent_ComponentWithoutStartAnnotation_IsNotDeployed() throws Exception {
        // given
        RuntimeEnvironment environment = RuntimeEnvironment.getInstance();      
    ...
    @Test
    public void startComponent_ComponentWithStartAnnotation_IsStarted() throws Exception {
        // given
        RuntimeEnvironment environment = RuntimeEnvironment.getInstance();
        environment.deployComponent(path_to_jar_with_annotation);
    ...
    @Test
    public void startComponent_ComponentWithoutStartAnnotation_IsNotStarted() throws Exception {
        // given
        RuntimeEnvironment environment = RuntimeEnvironment.getInstance();
        environment.deployComponent(path_to_jar_without_annotation);
